/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 42edf241df621e54347dbc51db8c3360)
// Runtime types generated with workerd@1.20260918.1 2026-09-18 
interface __BaseEnv_Env {
	theo: D1Database;
	VITE_SYNC_PROTOCOL: string;
	VITE_API_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_SYNC_PROTOCOL" | "VITE_API_URL">> {}
}
